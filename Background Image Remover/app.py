...
def build_ui():
    ...
    st.markdown("### Image Backgroud Remover ✂️")
    ...
    <p>Developed with ❤ by <a href="https://github.com/Amanjain00" target="_blank">Aman Jain</a></p>
    </div>"""
...
if __name__ == "__main__":
    ...
    st.set_page_config(
        page_title="Background Image Remover",
        page_icon="✂️",
